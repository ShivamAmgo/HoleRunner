...
public class Projectile : MonoBehaviour
{
    ...
    public void Launch(Transform ShootPoint)
    {
        ...
        {
            Physics.IgnoreCollision(GroundCOllider, _collider, true);
        }
    ...
    void LaunchEnemy()
    {
        ...
        FLy = true;
        FlyRotTweeen = DOTween.To(() => FlyRot.x, value => FlyRot.x = value, -FlyRot.x, MidAIrRotationDuration)
            .SetEase(Ease.Linear)
            .OnUpdate(() => { transform.eulerAngles = FlyRot; }).OnStart(() =>
            {
